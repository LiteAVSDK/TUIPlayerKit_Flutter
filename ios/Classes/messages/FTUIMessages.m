...
@interface nullFTUIMessagesPigeonCodecReader : FlutterStandardReader
@end
@implementation nullFTUIMessagesPigeonCodecReader
...
@interface nullFTUIMessagesPigeonCodecWriter : FlutterStandardWriter
@end
@implementation nullFTUIMessagesPigeonCodecWriter
...
@interface nullFTUIMessagesPigeonCodecReaderWriter : FlutterStandardReaderWriter
@end
@implementation nullFTUIMessagesPigeonCodecReaderWriter
- (FlutterStandardWriter *)writerWithData:(NSMutableData *)data {
  return [[nullFTUIMessagesPigeonCodecWriter alloc] initWithData:data];
}
- (FlutterStandardReader *)readerWithData:(NSData *)data {
  return [[nullFTUIMessagesPigeonCodecReader alloc] initWithData:data];
}
@end
...
NSObject<FlutterMessageCodec> *nullGetFTUIMessagesCodec(void) {
  ...
  dispatch_once(&sPred, ^{
    nullFTUIMessagesPigeonCodecReaderWriter *readerWriter = [[nullFTUIMessagesPigeonCodecReaderWriter alloc] init];
  ...
  messageChannelSuffix = messageChannelSuffix.length > 0 ? [NSString stringWithFormat: @".%@", messageChannelSuffix] : @"";
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        ...
        codec:nullGetFTUIMessagesCodec()];
    if (api) {
