...
class DemoVideoSourceFactory {

  List<FTUIVideoSource> loadData() {
    ...
    dataList.add(FTUIVideoSource()
      ..appId = 1500005830
      ..fileId = "387702294167066515"
      ..coverPictureUrl =
          "http://1500005830.vod2.myqcloud.com/43843ec0vodtranscq1500005830/6fc8e954387702294167066515/coverBySnapshot/coverBySnapshot_10_0.jpg");
